...
public List<Mariage> getMariagesDetails(Homme homme) {
...
public static void getEpousesParHomme(Homme homme) {
 ...
 public void HommeQuatreFemme(Date startDate, Date endDate) {
        Session session = HibernateUtil.getSessionFactory().openSession();
...
public int countHommeQuatreFemme(Date startDate, Date endDate) {
    Session session = null;
    int count = 0;
